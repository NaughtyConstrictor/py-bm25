# taken from https://github.com/dorianbrown/rank_bm25/blob/master/rank_bm25.py
# there's an error in the formula of BM25L from the rank_bm25 package
# the version on github has the correct formula
